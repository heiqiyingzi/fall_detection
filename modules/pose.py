...
def track_poses(previous_poses, current_poses, threshold=3, smooth=False):
    ...
    for current_pose in current_poses:
        ...
        if best_matched_id is not None:
            diff_y_1 = current_pose.keypoints[1][1] - previous_poses[best_matched_id].keypoints[1][1]
            diff_y_1_list.append(diff_y_1)
        else:
            diff_y_1_list.append(0)
            # diff_y_1 = ((current_pose.keypoints[1][0]-previous_poses[best_matched_id].keypoints[1][0])**2 + (current_pose.keypoints[1][1]-previous_poses[best_matched_id].keypoints[1][1])**2)**0.5
    ...
    return diff_y_1_list

# def fall_detection(diff_y_1_list, dur):
